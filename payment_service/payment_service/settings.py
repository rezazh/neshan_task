...
SECRET_KEY = 'django-insecure-4#6%$%zx*m_-f!dp3)g)cn-pji9@yazo-p@j3oacje3l20a2^@'
...
CELERY_BEAT_SCHEDULE = {
    'summarize-request-logs-every-30-days': {
        'task': 'payments.tasks.summarize_request_logs',
